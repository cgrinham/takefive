...
urlpatterns = patterns('',
    ...
    url(r'^ajax/eventdelete/$', views.ajaxeventdelete, name='ajaxeventdelete'),
    url(r'^ajax/recceventdeleteall/$', views.ajaxrecceventdeleteall, name='ajaxrecceventdeleteall'),
    url(r'^ajax/recceventdeletedate/$', views.ajaxrecceventdeletedate, name='ajaxrecceventdeletedate'),
    ...
    url(r'^(?P<company>\w+)/(?P<venue>\w+)/event/newrecurring/$', views.newrecurringevent, name='newrecurringevent'),
    url(r'^(?P<company>\w+)/(?P<venue>\w+)/event/recurring/(?P<event>\w+)/$', views.viewrecurringevent, name='viewrecurringevent'),
